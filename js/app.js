$(function() {
    ...
    function skillAnimation() {
        ...
        setTimeout(function() {
            $(".circle_1").circleProgress({
                ...
                $(this).find(".circle-percent_1").html(parseInt(85 * progress) + '<i>%</i>');
            });

            $(".circle_2").circleProgress({
                value: 0.81
            }).on('circle-animation-progress', function(event, progress) {
                $(this).find(".circle-percent_2").html(parseInt(81 * progress) + '<i>%</i>');
            });

            $(".circle_3").circleProgress({
                value: 0.87
            }).on('circle-animation-progress', function(event, progress) {
                $(this).find(".circle-percent_3").html(parseInt(87 * progress) + '<i>%</i>');
            });

            $(".circle_4").circleProgress({
                value: 0.83
            }).on('circle-animation-progress', function(event, progress) {
                $(this).find(".circle-percent_4").html(parseInt(83 * progress) + '<i>%</i>');
            });

            $(".circle_5").circleProgress({
                value: 0.71
            }).on('circle-animation-progress', function(event, progress) {
                $(this).find(".circle-percent_5").html(parseInt(71 * progress) + '<i>%</i>');
            });

            $(".circle_6").circleProgress({
                value: 0.89
            }).on('circle-animation-progress', function(event, progress) {
                $(this).find(".circle-percent_6").html(parseInt(89 * progress) + '<i>%</i>');
            });

            $(".circle_7").circleProgress({
                value: 0.89
            }).on('circle-animation-progress', function(event, progress) {
                $(this).find(".circle-percent_7").html(parseInt(89 * progress) + '<i>%</i>');
            });

            $(".circle_8").circleProgress({
                value: 0.61
            }).on('circle-animation-progress', function(event, progress) {
                $(this).find(".circle-percent_8").html(parseInt(61 * progress) + '<i>%</i>');
            });
        }, 1000);
    }
    ...
    function educationAnimation() {
        ...
        $("#education-item-wrapper-01, #education-item-wrapper-02, #education-item-wrapper-03, #education-item-wrapper-04").animateCss('fadeIn');
        $("#education-info-holder-01, #education-info-holder-02, #education-info-holder-03, #education-info-holder-04").animateCss('bounceInLeft');
        $("#education-desc-holder-01, #education-desc-holder-02, #education-desc-holder-03, #education-desc-holder-04").animateCss('bounceInRight');
        $(".education-item-mobile-lv1, .education-item-mobile-lv2, .education-item-mobile-lv3, .education-item-mobile-lv4").animateCss('fadeIn');
    }

    function experienceAnimation() {
        $("#experience").css('opacity', '1');
        $("#experience-header").animateCss('bounceInDown');
        $("#experience-item-wrapper-01, #experience-item-wrapper-02, #experience-item-wrapper-03, #experience-item-wrapper-04").animateCss('fadeIn');
        $("#experience-info-holder-01, #experience-info-holder-02, #experience-info-holder-03, #experience-info-holder-04").animateCss('bounceInLeft');
        $("#experience-desc-holder-01, #experience-desc-holder-02, #experience-desc-holder-03, #experience-desc-holder-04").animateCss('bounceInRight');
        $(".experience-item-mobile-lv1, .experience-item-mobile-lv2, .experience-item-mobile-lv3, .experience-item-mobile-lv4").animateCss('fadeIn');
    }
    ...
    function portfolioAnimation() {
        ...
        $(".elem-wrapper-upper-plus").animateCss('zoomIn');
        $(".elem-wrapper-middle-plus").animateCss('zoomIn');
        $(".elem-wrapper-below-plus").animateCss('zoomIn');
